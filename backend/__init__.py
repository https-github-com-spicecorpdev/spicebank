...
def get_repositories():
    ...
    dateTimeDatabase = DateTimeDatabase(connection)
    return accountDatabase, statementDatabase, solicitationDatabase, bankDatabase, userDatabase, agencyDatabase, dateTimeDatabase
